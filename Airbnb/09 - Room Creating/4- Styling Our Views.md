...
```
-----------------------------------------------------------------------------------------
Create Views for Room
Create Room Index (View)
Ouvrir : views/rooms/index.html.erb
...
Ouvrir ```views/rooms/show.html.erb```
```
<div class="panel panel-default">
	<div class="panel-body">
...
Puis créer ds ```asset/stylesheets/pages``` : ```_roomshow.scss```
Puis dans ```asset/stylesheets/pages/_index.scss``` , ajouter: ```@import "roomshow";```
